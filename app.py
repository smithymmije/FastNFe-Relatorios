...
def generate_report():
    ...
    if produtos_maior_valor and "Número da Nota" in report_data and "Emitente Nome" in report_data:
        ...
        motivo = f'Motivo: {", ".join(descricoes_maior_valor)}, alocados direto na filial XX, para atender demandas de limpeza, referente a Maio/2025 - NF {report_data["Número da Nota"]} Fornecedor {report_data["Emitente Nome"]}'
